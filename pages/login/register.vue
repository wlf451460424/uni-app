		...
		<view class="login-form">
			<form @submit="formSubmit">
				<view class="form-input">
					<input ref="username_input" type="text" value="" placeholder="用户名" />
				</view>
				<view class="form-input">
					<input ref="password_input" type="password" value="" placeholder="密码" @focus="passwordF_B" @blur="passwordF_B" />
				</view>
				<button type="primary" form-type="submit" style="background-color: #4CBDF3;">登录</button>
			</form>
		</view>
	</view>
</template>
	...
	export default {
		...
		methods: {
			...
			formSubmit(e) {
				...
				uni.request({
				    url: 'http://47.92.195.101:8888/user/login/token',
				    data: {
						"username": "wangdaye",
						"password": "123456789"
				    },
