	...
	<view class="content">
		...
		<mix-pulldown-refresh ref="mixPulldownRefresh" class="panel-content" :top="90" @refresh="onPulldownReresh" @setEnableScroll="setEnableScroll">
			...
			>
				...
				<swiper-item>
					<scroll-view class="panel-scroll-box" :scroll-y="enableScroll" @scrolltolower="loadMore" >
						<view class="swiper-item uni-bg-red" > <text v-for="n in 100" :key="n">{{ n }} </text> </view>
						<mix-load-more :status="loadMoreStatus"></mix-load-more>
					</scroll-view>
				</swiper-item>
				<swiper-item>
					<scroll-view class="panel-scroll-box" :scroll-y="enableScroll" @scrolltolower="loadMore" >
						<view class="swiper-item uni-bg-green" > <text v-for="n in 100" :key="n">{{ n }} </text> </view>
						<mix-load-more :status="loadMoreStatus"></mix-load-more>
					</scroll-view>
				</swiper-item>
				<swiper-item>
					<scroll-view class="panel-scroll-box" :scroll-y="enableScroll" @scrolltolower="loadMore" >
						<view class="swiper-item uni-bg-blue" > <text v-for="n in 100" :key="n">{{ n }} </text> </view>
						<mix-load-more :status="loadMoreStatus"></mix-load-more>
					</scroll-view>
				</swiper-item>
			</swiper>
